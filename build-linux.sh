#!/usr/bin/env bash
# Builda o instalador Linux (AppImage + .deb) em app/electron/dist.
# Rodar numa maquina Linux (electron-builder nao faz cross-compile confiavel).
set -e
cd "$(dirname "$0")"
...
echo "==> Pronto. Instaladores em app/electron/dist/"
